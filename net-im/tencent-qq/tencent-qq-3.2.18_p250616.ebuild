...
# Newer QQ versions suck, so this ebuild is for stucking to the last good version.
...
MY_PV="${PV/_p/_}"
_QQDownloadURLPrefix="https://web.archive.org/web/20250702150255/https://dldir1v6.qq.com/qqfile/qq/QQNT/Linux"
_LiteLoader_PV="1.3.0"

DESCRIPTION="The new version ofhe official linux-qq"
